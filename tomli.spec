...
Source0  : https://files.pythonhosted.org/packages/6c/16/f48ab3289015f8f90e2c68fb76531728b3d8e4ce5052ee80ad10e7707eda/tomli-1.1.0.tar.gz
...
%prep
%setup -q -n tomli-1.1.0
cd %{_builddir}/tomli-1.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627401877
...
cp %{_builddir}/tomli-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/tomli/9da6ca26337a886fb3e8d30efd4aeda623dc9ade
