...
Source0  : https://files.pythonhosted.org/packages/35/b9/de2a5c0144d7d75a57ff355c0c24054f965b2dc3036456ae03a51ea6264b/tomli-2.0.2.tar.gz
...
%prep
%setup -q -n tomli-2.0.2
cd %{_builddir}/tomli-2.0.2
pushd ..
cp -a tomli-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727897416
...
cp %{_builddir}/tomli-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tomli/9da6ca26337a886fb3e8d30efd4aeda623dc9ade || :
