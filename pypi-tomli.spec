...
Source0  : https://files.pythonhosted.org/packages/18/87/302344fed471e44a87289cf4967697d07e532f2421fdaf868a303cbae4ff/tomli-2.2.1.tar.gz
...
%prep
%setup -q -n tomli-2.2.1
cd %{_builddir}/tomli-2.2.1
pushd ..
cp -a tomli-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733242233
